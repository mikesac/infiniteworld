...
try{
	...
	x_initiative = String.valueOf(rs.getLong("initiative"));
		...
		// Open record
		String strsql = "SELECT * FROM `Spell` WHERE 0 = 1";
		rs = stmt.executeQuery(strsql);
		rs.moveToInsertRow();
...
<p><span class="jspmaker">Add to TABLE: Spell<br><br><a href="spelllist.jsp">Back to List</a></span></p>
...
<form onSubmit="return EW_checkMyForm(this);"  action="spelladd.jsp" method="post">
<p>
<input type="hidden" name="a" value="A">
<table class="ewTable">
	<tr>
		<td class="ewTableHeader">name&nbsp;</td>
		<td class="ewTableAltRow"><% if (x_name== null || ((String)x_name).equals("")) {x_name = "NoSpell"; } // set default value %><input type="text" name="x_name" size="30" maxlength="255" value="<%= HTMLEncode((String)x_name) %>">&nbsp;</td>
	</tr>
	<tr>
		<td class="ewTableHeader">desc&nbsp;</td>
		<td class="ewTableAltRow"><% if (x_desc== null || ((String)x_desc).equals("")) {x_desc = "nospell"; } // set default value %><input type="text" name="x_desc" size="30" maxlength="255" value="<%= HTMLEncode((String)x_desc) %>">&nbsp;</td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td class="ewTableAltRow"><% if (x_costMp== null || ((String)x_costMp).equals("")) {x_costMp = "1"; } // set default value %><input type="text" name="x_costMp" size="30" value="<%= HTMLEncode((String)x_costMp) %>">&nbsp;</td>
	</tr>
	<tr>
		<td class="ewTableHeader">req str&nbsp;</td>
		<td class="ewTableAltRow"><% if (x_req_str== null || ((String)x_req_str).equals("")) {x_req_str = "0"; } // set default value %><input type="text" name="x_req_str" size="30" value="<%= HTMLEncode((String)x_req_str) %>">&nbsp;</td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td class="ewTableAltRow"><% if (x_req_cha== null || ((String)x_req_cha).equals("")) {x_req_cha = "0"; } // set default value %><input type="text" name="x_req_cha" size="30" value="<%= HTMLEncode((String)x_req_cha) %>">&nbsp;</td>
	</tr>
	<tr>
		<td class="ewTableHeader">req lev&nbsp;</td>
		<td class="ewTableAltRow"><% if (x_req_lev== null || ((String)x_req_lev).equals("")) {x_req_lev = "0"; } // set default value %><input type="text" name="x_req_lev" size="30" value="<%= HTMLEncode((String)x_req_lev) %>">&nbsp;</td>
	</tr>
	<tr>
		<td class="ewTableHeader">mod str&nbsp;</td>
		<td class="ewTableAltRow"><% if (x_mod_str== null || ((String)x_mod_str).equals("")) {x_mod_str = "0"; } // set default value %><input type="text" name="x_mod_str" size="30" value="<%= HTMLEncode((String)x_mod_str) %>">&nbsp;</td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td class="ewTableAltRow"><% if (x_mod_dex== null || ((String)x_mod_dex).equals("")) {x_mod_dex = "0"; } // set default value %><input type="text" name="x_mod_dex" size="30" value="<%= HTMLEncode((String)x_mod_dex) %>">&nbsp;</td>
	</tr>
	<tr>
		<td class="ewTableHeader">mod cha&nbsp;</td>
		<td class="ewTableAltRow"><% if (x_mod_cha== null || ((String)x_mod_cha).equals("")) {x_mod_cha = "0"; } // set default value %><input type="text" name="x_mod_cha" size="30" value="<%= HTMLEncode((String)x_mod_cha) %>">&nbsp;</td>
	</tr>
	<tr>
		<td class="ewTableHeader">price&nbsp;</td>
		<td class="ewTableAltRow"><% if (x_price== null || ((String)x_price).equals("")) {x_price = "0"; } // set default value %><input type="text" name="x_price" size="30" value="<%= HTMLEncode((String)x_price) %>">&nbsp;</td>
	</tr>
	<tr>
		<td class="ewTableHeader">lev&nbsp;</td>
		<td class="ewTableAltRow"><% if (x_lev== null || ((String)x_lev).equals("")) {x_lev = "0"; } // set default value %><input type="text" name="x_lev" size="30" value="<%= HTMLEncode((String)x_lev) %>">&nbsp;</td>
	</tr>
	<tr>
		<td class="ewTableHeader">duration&nbsp;</td>
		<td class="ewTableAltRow"><% if (x_duration== null || ((String)x_duration).equals("")) {x_duration = "0"; } // set default value %><input type="text" name="x_duration" size="30" value="<%= HTMLEncode((String)x_duration) %>">&nbsp;</td>
	</tr>
	<tr>
		<td class="ewTableHeader">spelltype&nbsp;</td>
		<td class="ewTableAltRow"><% if (x_spelltype== null || ((String)x_spelltype).equals("")) {x_spelltype = "0"; } // set default value %><input type="text" name="x_spelltype" size="30" value="<%= HTMLEncode((String)x_spelltype) %>">&nbsp;</td>
	</tr>
	<tr>
		<td class="ewTableHeader">damage&nbsp;</td>
		<td class="ewTableAltRow"><% if (x_damage== null || ((String)x_damage).equals("")) {x_damage = "0"; } // set default value %><input type="text" name="x_damage" size="30" maxlength="128" value="<%= HTMLEncode((String)x_damage) %>">&nbsp;</td>
	</tr>
	<tr>
		<td class="ewTableHeader">savingthrow&nbsp;</td>
		<td class="ewTableAltRow"><% if (x_savingthrow== null || ((String)x_savingthrow).equals("")) {x_savingthrow = "-1"; } // set default value %><input type="text" name="x_savingthrow" size="30" value="<%= HTMLEncode((String)x_savingthrow) %>">&nbsp;</td>
	</tr>
	<tr>
		<td class="ewTableHeader">initiative&nbsp;</td>
		<td class="ewTableAltRow"><% if (x_initiative== null || ((String)x_initiative).equals("")) {x_initiative = "1"; } // set default value %><input type="text" name="x_initiative" size="30" value="<%= HTMLEncode((String)x_initiative) %>">&nbsp;</td>
	</tr>
</table>
<p>
