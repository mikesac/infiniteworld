...
<table class="ewTable">
	...
	<tr>
		...
		<td class="ewTableAltRow"><% if (x_ax== null || ((String)x_ax).equals("")) {x_ax = "0"; } // set default value %><input type="text" name="x_ax" size="30" value="<%= HTMLEncode((String)x_ax) %>">&nbsp;</td>
	</tr>
	<tr>
		<td class="ewTableHeader">ay&nbsp;</td>
		<td class="ewTableAltRow"><% if (x_ay== null || ((String)x_ay).equals("")) {x_ay = "0"; } // set default value %><input type="text" name="x_ay" size="30" value="<%= HTMLEncode((String)x_ay) %>">&nbsp;</td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td class="ewTableAltRow"><% if (x_lockid== null || ((String)x_lockid).equals("")) {x_lockid = "1"; } // set default value %><input type="text" name="x_lockid" size="30" value="<%= HTMLEncode((String)x_lockid) %>">&nbsp;</td>
	</tr>
	<tr>
