...
try{
	...
	x_type = String.valueOf(rs.getLong("type"));
		...
		// Open record
		String strsql = "SELECT * FROM `Item` WHERE 0 = 1";
		rs = stmt.executeQuery(strsql);
		rs.moveToInsertRow();
...
<p><span class="jspmaker">Add to TABLE: Item<br><br><a href="itemlist.jsp">Back to List</a></span></p>
...
<form onSubmit="return EW_checkMyForm(this);"  action="itemadd.jsp" method="post">
<p>
<input type="hidden" name="a" value="A">
<table class="ewTable">
	<tr>
		<td class="ewTableHeader">name&nbsp;</td>
		<td class="ewTableAltRow"><% if (x_name== null || ((String)x_name).equals("")) {x_name = "NoItem"; } // set default value %><input type="text" name="x_name" size="30" maxlength="255" value="<%= HTMLEncode((String)x_name) %>">&nbsp;</td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td class="ewTableAltRow"><% if (x_costAP== null || ((String)x_costAP).equals("")) {x_costAP = "0"; } // set default value %><input type="text" name="x_costAP" size="30" value="<%= HTMLEncode((String)x_costAP) %>">&nbsp;</td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td class="ewTableAltRow"><% if (x_spell== null || ((String)x_spell).equals("")) {x_spell = "0"; } // set default value %><input type="text" name="x_spell" size="30" value="<%= HTMLEncode((String)x_spell) %>">&nbsp;</td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td class="ewTableAltRow"><% if (x_durability== null || ((String)x_durability).equals("")) {x_durability = "1"; } // set default value %><input type="text" name="x_durability" size="30" value="<%= HTMLEncode((String)x_durability) %>">&nbsp;</td>
	</tr>
	<tr>
		<td class="ewTableHeader">type&nbsp;</td>
		<td class="ewTableAltRow"><% if (x_type== null || ((String)x_type).equals("")) {x_type = "0"; } // set default value %><input type="text" name="x_type" size="30" value="<%= HTMLEncode((String)x_type) %>">&nbsp;</td>
	</tr>
</table>
<p>
