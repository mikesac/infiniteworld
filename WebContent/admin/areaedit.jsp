...
<p><span class="jspmaker">Edit TABLE: Area<br><br><a href="arealist.jsp">Back to List</a></span></p>
...
<form onSubmit="return EW_checkMyForm(this);"  name="Areaedit" action="areaedit.jsp" method="post">
<p>
