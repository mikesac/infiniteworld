...
// Generated 31-mar-2009 22.04.44 by Hibernate Tools 3.2.4.CR1
...
public class PlayerKnowSpellHome {
	...
	public PlayerKnowSpell findById(java.lang.Integer id) {
	...
	public List<PlayerKnowSpell> findByExample(PlayerKnowSpell instance) {
		log.debug("finding PlayerKnowSpell instance by example");
		try {
			List<PlayerKnowSpell> results = (List<PlayerKnowSpell>) sessionFactory
