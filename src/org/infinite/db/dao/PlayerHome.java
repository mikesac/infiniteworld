 ...
 * @see org.infinite.db.dao.Player
...
public class PlayerHome {
	...
	public List<Player> findByExample(Player instance) {
		...
		try {
			List<Player> results = (List<Player>) sessionFactory
					.getCurrentSession().createCriteria(
							"org.infinite.db.dao.Player").add(create(instance))
					.list();
